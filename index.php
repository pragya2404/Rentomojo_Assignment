...
if(isset($_POST['submit'])){
	...
	echo '<p class="errorMsg">All the fields are required</p>'; 
		...
		$sql = mysqli_query($con,"SELECT * FROM userdetails WHERE username = '$username' AND password = '$password'");
...
<body>
 ...
 Username<span style="color:yellow;">*</span><input type="text" name ="username1" ><br>
 Password<span style="color:yellow;">*</span><input type="password" name="password" ><br>
